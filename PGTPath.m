...
@implementation PGTPath

@synthesize points = _points, pointCount;
...
- (id)initWithCenterCoordinate:(CLLocationCoordinate2D)coord
{
    ...
    if (self)
	{
        ...
        //self.points = [[NSMutableArray alloc] initWithCapacity:1000];
        self.points[0] = MKMapPointForCoordinate(coord);
        //[self.points addObject:coord];
        pointCount = 1;
